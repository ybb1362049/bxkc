 ...
 *
 */
public class QX_01412_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// re_rows
				String syntaxOfRows = "tr[height]:has(td[class=tdclass]:has(a[href*=/ZWGK_info_content]))";// span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
