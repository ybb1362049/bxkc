...
public class DS_00456_1_List2 extends TxtRspHandler {
		...
		if (rspState == RspState.Login) {
			try {
				...
				for(int i=0;i<jArray.length();i++)
				{
					...
					String title=jso.getString("placard_name");
					String id=jso.getString("placard_id");
					String date=jso.getString("placard_send_date");
					if(date.contains("/")){
						date=date.replace("/", "-");
					}
