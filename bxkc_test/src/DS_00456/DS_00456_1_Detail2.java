...
public class DS_00456_1_Detail2 extends TxtRspHandler {
			...
			//	System.out.println(originTxtRspContent);
				...
				if(divs!=null){
					for(int i = 0;i<divs.getLength();i++){
						...
						if("easyui-panel".equals(div_ee.getAttribute("class"))){
							div_ee.getElementsByTagName("div").item(1).setTextContent(null);
