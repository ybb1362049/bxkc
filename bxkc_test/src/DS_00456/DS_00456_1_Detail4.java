...
public class DS_00456_1_Detail4 extends TxtRspHandler {
			...
			//	System.out.println(originTxtRspContent);
				...
				if(divs!=null){
					for(int i = 0;i<divs.getLength();i++){
						...
						if("width: 88%;".equals(div_ee.getAttribute("style"))){
							
							//div_ee.getElementsByTagName("tr").item(0).setTextContent(null);
							div_ee.getElementsByTagName("p").item(1).setTextContent(null);
