...
public class DS_00848_List4 extends TxtRspHandler {
			...
			try {
				...
				for(int i = 0 ; i < oo.length() ; i++){
					...
					String url = getNewPathPrefix() + "/?" + getAdditionalLinkParamStr()
							+ "&iw-cmd=DS_00848_Detail&iw_ir_1=/pwq/" + id + "&type=4";
					String longDate = o.get("createtime").toString();
					String date = sdf.format(new Date(Long.valueOf(longDate) * 1000));
					
					String extraInfo = "中标公告";
