...
public class DS_00848_List2 extends TxtRspHandler {
			...
			try {
				...
				for(int i = 0 ; i < oo.length() ; i++){
					...
					String url = getNewPathPrefix() + "/?" + getAdditionalLinkParamStr()
							+ "&iw-cmd=DS_00848_Detail&iw_ir_1=/deal/" + id + "&type=3";
					...
					String issupple = o.get("issupple").toString();//补遗
					if("1".equals(issupple)){
						extraInfo = "招标答疑";
					}
