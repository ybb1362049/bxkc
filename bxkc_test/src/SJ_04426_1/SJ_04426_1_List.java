 ...
 *
 */
public class SJ_04426_1_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// re_rows
				String syntaxOfRows = "li:has(span[class*=ctrt]:has(a[href*=Info]))";// span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				OUTFOR: for (Element row : rows) {
					...
					// re_date
					String regexOfDate = "span[class=ctrt_news_nr_spright]";
