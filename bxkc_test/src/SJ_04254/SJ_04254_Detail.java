...
public class SJ_04254_Detail extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element detailDivEle = document.select("div[style~=width:98%;padding-left:10px]").get(2);
				Element titleDivEle = document.select("div[style=font-size:18px; width:98%; padding-left:10px;border-bottom:1px dashed #CECDCD;margin-bottom:0px; padding-bottom:7px;]").first();
