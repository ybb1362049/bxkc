...
public class SJ_04254_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element list_ee = document.select("div[class=Newscontent]").last();
				...
				Element page_ee = document.select("td[style=width:40%;font-size: 12px]").first();
				if (page_ee != null) {
