...
public class DX000589_Detail extends TxtRspHandler {
	...
	private static String url = "http://www.scsgsx.com";
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				String content = "";
				Element div = doc.select("div.mycontent").first();
				if (div != null) {
					div.select("script").remove();
					div.select("div#ctl00_ContentPlaceHolder1_about_ctl00_proInfo").remove();
