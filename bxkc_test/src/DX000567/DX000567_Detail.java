...
public class DX000567_Detail extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element titElement = xml.select("div.ctt_web_title").first();
				Element content = xml.select("div.ctt_web_span").first();
