...
public class DS_00097_List4 extends TxtRspHandler {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-mm-dd");

	public DS_00097_List4() {
		...
		if (arg0 == RspState.Login) {
			try {
				...
				for (int i = 0 ; i < list.length() ; i++) {
					...
					bn.title = obj1.getString("bidsectionname");
					bn.id = obj1.getString("id");
					String evaluationtype = obj1.getString("evaluationtype");
					System.out.println(evaluationtype);
					if ("21".equals(evaluationtype)) {
						typeid = "26";
					}
					if ("22".equals(evaluationtype)) {
						typeid = "968";
					}
