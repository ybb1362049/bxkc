 ...
 *
 */
public class QX_01413_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// re_rows
				String syntaxOfRows = "li:has(span[class=fl]:has(a[href]))";// span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
