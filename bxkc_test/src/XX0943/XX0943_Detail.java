...
public class XX0943_Detail extends TxtRspHandler {
	...
	String url = "http://www.cqyygz.com";
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				String content = "";
				Element dive = doc.select("div[class=titleset1]").first();
				{
					content=dive.outerHtml();
				}
				Element div = doc.select("div[id=content]").first();
				if (div != null) {
