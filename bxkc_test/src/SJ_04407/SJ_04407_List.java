 ...
 *
 */
public class SJ_04407_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{tr>td[width=95%]>li[style]>a[href*=.Asp]}::<3";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfDate = "";
				String regexOfPage = "{table[width=98%]>tbody>tr>td[align=center]}::<3";
