...
public class QX_01102_List extends TxtRspHandler {
		...
		if (rspState == RspState.Login) {
			try {
				...
				for (Element list : listElement) {
					...
					+ "&iw-cmd=QX_01102_Detail&iw_ir_2=" + id;
					bn.url=url;
					bn.title = title;
					bn.id = id;
					bn.date=dateString;
