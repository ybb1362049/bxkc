 ...
 *
 */
public class SJ_04425_1_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{li>em+a[href*=/show]}::<2";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfDate = "em";
				String regexOfPage = "{div[class=page]}::<1";
