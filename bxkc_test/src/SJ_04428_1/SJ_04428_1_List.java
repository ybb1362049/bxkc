 ...
 *
 */
public class SJ_04428_1_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{li>span[style]>a[title]}::<3";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfDate = "";
				String regexOfPage = "{table[id=Page]}::<1";
