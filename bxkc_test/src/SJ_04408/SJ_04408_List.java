 ...
 *
 */
public class SJ_04408_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{tr>td[width=88%]>a[href*=news_in.asp]}::<3";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfPage = "{table[class=lv]:has(form)}::<1";
