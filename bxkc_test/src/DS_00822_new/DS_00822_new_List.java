...
public class DS_00822_new_List extends TxtRspHandler{
		...
		if(rspstate==RspState.Login)
		{
			try{  
				...
				for(int i=0;i<table_list.getLength();i++){
					...
					if("100%".equals(table_eles.getAttribute("width"))){
						        NodeList table_el=table_eles.getElementsByTagName("tr");
								...
								Element dat=(Element) table_ele.getElementsByTagName("td").item(2);
