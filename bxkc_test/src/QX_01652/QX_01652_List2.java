...
public class QX_01652_List2 extends TxtRspHandler {
		...
		if (rspState == RspState.Login) {
			try {
				...
				for (Element list : listElement) {
					...
					+ "&iw-cmd=QX_01652_Detail&iw_ir_2=" + id;
					bn.url=url;
					bn.title = title;
					bn.id = id;
					bn.date=dateString;
