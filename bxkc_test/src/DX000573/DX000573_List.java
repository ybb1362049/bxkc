...
public class DX000573_List extends TxtRspHandler {
		...
		if (rspState == RspState.Login) {
			try {
				...
				for (Element list : listElement) {
					...
					+ "&iw-cmd=DX000573_Detail&iw_ir_2=" + id;
					bn.url=url;
					bn.title = title;
					bn.id = id;
