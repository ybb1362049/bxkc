 ...
 *
 */
public class QX_01422_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// re_rows
				String syntaxOfRows = "li[class=pointL]:has(span:matches(20\\d{2}-\\d{1,2}-\\d{1,2}))";// span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
