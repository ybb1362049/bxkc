...
public class DS_00593_Detail2 extends TxtReqRspHandler {
	...
	public IwResponse sendIwRequest(IwRequest iwRequest) {
		...
		try {
			String guid = iwRequest.getRequestPathParam("XinXi_Publish_Guid");
			String XinXi_Type = iwRequest.getRequestPathParam("XinXi_Type");
			this.path = "http://" + iwRequest.getHost() + ":" + iwRequest.getPort() + iwRequest.getRequestPath()
					+ "?XinXi_Publish_Guid=" + guid + "&XinXi_Type=" + XinXi_Type;
