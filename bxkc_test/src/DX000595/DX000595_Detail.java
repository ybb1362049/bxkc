...
public class DX000595_Detail extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element titElement = xml.select("div.title").first();
				Element content = xml.select("div[class=content box_img]").first();
