...
public class QX_01645_Detail extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element titElement = xml.select("div.information_title").first();
				Element content = xml.select("div.information_content").first();
