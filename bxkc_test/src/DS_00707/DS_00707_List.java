...
public class DS_00707_List extends TxtRspHandler {
...
//							Element div2=(Element) div_list.item(j+2);
							Element SUP=(Element) ul_ele.getElementsByTagName("TD").item(1);
...
//							page=page.substring(page.indexOf("共")+1);
							page=page.substring(page.indexOf("共")+1,page.indexOf("，"));
//						}
