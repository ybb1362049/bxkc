 ...
 *
 */
public class DS_01086_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// re_rows
				String syntaxOfRows = "tr:not(:has(table)):has(td>img):has(a[href*=list.asp?NewsID=])";// span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
