...
public class DX000581_Detail extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				String remove = "h5,0 div.jtxw_dyy";
				boolean getdate = false;
				String dateString = "";

				Document xml = Jsoup.parse(originTxtRspContent);

				Element content = xml.select("div.jtxw").first();
				Element titElement = content.select("h2").first();
