 ...
 *
 */
public class SJ_04430_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{li>span+a[href*=.html]}::<2";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfPage = "{div[class=nav]}::<1";
