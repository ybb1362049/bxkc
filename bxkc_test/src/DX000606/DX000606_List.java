...
public class DX000606_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == RspState.Login) {
			try {
				...
				Element list_ee = document.select("div[class=List3 BorderCCCNoTop]").first();
				...
				Element page_ee = document.select("div[style=width:350px;padding:10px;margin:0 auto;]").last();
				if(page_ee!=null){
