 ...
 *
 */
public class SJ_04404_List extends TxtRspHandler {
	...
	protected TxtRspObject processTxtRspContent(RspState rspState, String originTxtRspContent) {
		...
		if (rspState == rsp) {
			try {
				...
				// 具体赋值
				String syntaxOfRows = "{tr>td[class=rq]>a[class=btwz0]}::<3";//span:matches(20\\d{2}-\\d{1,2}-\\d{1,2})
				...
				String regexOfDate = "span[class=rq]";
				String regexOfPage = "{span[class=zwz]}::<1";
